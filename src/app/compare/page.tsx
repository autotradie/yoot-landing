...
export const metadata: Metadata = {
  title: 'Compare',
  description: 'How YOOT compares to other tradie software.',
  robots: { index: false },
}
...
export default function Compare() {
  return (
    <main className="min-h-screen px-6 py-16 max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-yoot-navy mt-8 mb-4">Compare</h1>
      <div className="bg-white rounded-2xl border border-yoot-border shadow-sm p-8 text-center">
        ...
        <p className="text-sm text-yoot-slate mt-1">Honest comparisons with other tradie software.</p>
      </div>
